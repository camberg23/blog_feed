...
custom_text = st.text_input("Add Custom Phrases (Optional)", st.session_state.custom_text)
title_search = st.text_input("Title Search (Optional)", st.session_state.title_search)
